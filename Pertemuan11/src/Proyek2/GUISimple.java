...
public class GUISimple extends javax.swing.JFrame {
    ...
    private void aturTampilan() {
        java.awt.Color latar = new java.awt.Color(248, 246, 241);
        java.awt.Color primer = new java.awt.Color(30, 95, 116);
        java.awt.Color aksen = new java.awt.Color(222, 241, 239);

        getContentPane().setBackground(latar);
        jListItem.setBackground(aksen);
        jListItem.setForeground(new java.awt.Color(27, 54, 61));
        ...
        javax.swing.JButton[] tombol = {btnInsert, btnAdd, btnUpdate, btnDelete, btnClearAll};
