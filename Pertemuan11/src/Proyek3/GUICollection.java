...
public class GUICollection extends javax.swing.JFrame {
    ...
    private void aturTampilan() {
        java.awt.Color latar = new java.awt.Color(244, 247, 245);
        java.awt.Color primer = new java.awt.Color(91, 74, 145);
        java.awt.Color daftar = new java.awt.Color(235, 232, 246);

        getContentPane().setBackground(latar);
        jListItem.setBackground(daftar);
        jListItem.setForeground(new java.awt.Color(39, 36, 55));
        jListItem.setSelectionBackground(primer);
        jListItem.setSelectionForeground(java.awt.Color.WHITE);
        jLabelJumlahData.setForeground(primer);
        jTextFieldItem.setBackground(java.awt.Color.WHITE);

        javax.swing.JButton[] tombol = {btnInsert, btnSaveData, btnAdd, btnUpdate, btnDelete, btnClearAll};
